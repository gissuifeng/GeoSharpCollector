...
{
    public partial class WGS842GaodeForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public WGS842GaodeForm(MainForm mainform, SpreadsheetControl spreadsheetControl)
        {
            InitializeComponent();
        ...
        private void fun()
        {
            ...
            for (int i = 1; i < worksheetOriginal.GetDataRange().RowCount; i++)
            {
                ...
                gps = CoordUtil.gps84_To_Gcj02(oy, ox);
        ...
        private void WGS842GaodeForm_Load(object sender, EventArgs e)
        {
            comboBox_outputLng.EditValue = "gcj_lng";
            comboBox_outputLat.EditValue = "gjc_lat";
        }
