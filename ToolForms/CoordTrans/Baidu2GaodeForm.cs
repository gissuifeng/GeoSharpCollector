...
{
    public partial class Baidu2GaodeForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public Baidu2GaodeForm(MainForm mainform, SpreadsheetControl spreadsheetControl)
        {
            InitializeComponent();
        ...
        private void fun()
        {
            ...
            for (int i = 1; i < worksheetOriginal.GetDataRange().RowCount; i++)
            {
                ...
                gps = CoordUtil.bd09_To_Gcj02(oy, ox);
        ...
        private void Baidu2GaodeForm_Load(object sender, EventArgs e)
        {
            comboBox_outputLng.EditValue = "gcj_lng";
            comboBox_outputLat.EditValue = "gcj_lat";
        }
