...
{
    public partial class WGS842BaiduForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public WGS842BaiduForm(MainForm mainform, SpreadsheetControl spreadsheetControl)
        {
            InitializeComponent();
        ...
        private void fun()
        {
            ...
            for (int i = 1; i < worksheetOriginal.GetDataRange().RowCount; i++)
            {
                ...
                gps = CoordUtil.Gps84_To_bd09(oy, ox);
        ...
        private void WGS842Baidu_Load(object sender, EventArgs e)
        {
