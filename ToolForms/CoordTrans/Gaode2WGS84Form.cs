...
{
    public partial class Gaode2WGS84Form : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_inputOpen_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog.Filter = "excel2003文件|*.xls|excel文件|*.xlsx|csv文件|*.csv";
        ...
        private void fun()
        {
            ...
            for (int i = 1; i < worksheetOriginal.GetDataRange().RowCount; i++)
            {
                ...
                gps = CoordUtil.gcj_To_Gps84(oy, ox);
            ...
            progressBarControl1.ToolTip = "总共用时(时：分：秒)：" + ((temp_dt - pro_dt).ToString());
        }
        ...
        private void SetProgressValue(int value)
        {
            ...
            progressBarControl1.ToolTip = "当前已经用时(时：分：秒)：" + ((temp_dt-pro_dt).ToString()) ;
        }
        ...
        private void Gaode2WGS84Form_Load(object sender, EventArgs e)
        {
            comboBox_outputLng.EditValue = "wgs84_lng";
            comboBox_outputLat.EditValue = "wgs84_lat";
        }
        ...
        private void comboBox_outputLng_EditValueChanged(object sender, EventArgs e)
        {
            if (!isFirstLoad)
            {
                dxValidationProvider1.Validate();
        ...
        private void comboBox_outputLat_EditValueChanged(object sender, EventArgs e)
        {
            if (!isFirstLoad)
            {
                dxValidationProvider1.Validate();
